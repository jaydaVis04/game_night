export default function Icon({ name, size = 20, ...props }) {
  const paths = {
    ...
    trophy: (
      <>
        <path d="M7 3h10v6a5 5 0 0 1-10 0V3ZM12 14v5M8 21h8M7 5H3v3a4 4 0 0 0 4 4M17 5h4v3a4 4 0 0 1-4 4" />
      </>
    ),
    people: (
      <>
    ...
    dice: (
      <>
        ...
        <path d="M7 7h.01M17 7h.01M12 12h.01M7 17h.01M17 17h.01" strokeWidth="3" />
      </>
    ),
    settings: (
      <>
    ...
    mute: (
      <>
        <path d="m11 5-6 4H2v6h3l6 4V5ZM16 9l6 6M22 9l-6 6" />
      </>
    ),
    qr: (
      <>
        ...
        <path d="M15 15h3v3h3v3h-6v-3M3 12h8V3M12 15v6M18 12h3" />
      </>
    ),
    undo: (
      <>
        <path d="M3 10h11a7 7 0 0 1 0 14" transform="translate(0 -4)" />
        <path d="m7 2-4 4 4 4" />
      </>
    ),
